...
// IMPORTANTE: Se valida !process.env.K_SERVICE para asegurar que no estamos en Cloud Run (producción)
if (!process.env.K_SERVICE && process.env.DATABASE_URL && (process.env.DATABASE_URL.includes('136.112.170.11') || process.env.DATABASE_URL.includes('34.63.207.75'))) {
