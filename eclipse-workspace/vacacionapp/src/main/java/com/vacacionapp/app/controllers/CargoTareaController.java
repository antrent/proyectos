...
public class CargoTareaController {
	...
	public String guardar(@Valid CargoTarea cargoTarea, @Valid Tarea tareas, BindingResult result, Model model, RedirectAttributes flash, SessionStatus status) {
	
		System.out.println("Antonio2 ");
		
		System.out.println("Tarea "+tareas.getCodigo());
